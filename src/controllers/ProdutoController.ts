...
export function pegarTodosStatusDisponivel(req: Request, res: Response): void {
...
export function pegarPorId(req: Request, res: Response): void {
...
export function adicionar(req: Request,res: Response): void {
...
export function atualizaPorPartes(req: Request,res: Response): void {
...
export function atualizaCompleto(req: Request,res: Response): void {
    const indiceProduto = produtos.findIndex(produto => produto.id === Number.parseFloat(req.params.id));
    if(indiceProduto > -1){
        const produto = produtos[indiceProduto];
...
export function deleta(req: Request,res: Response): void {
    const indiceProduto = produtos.findIndex(produto => produto.id === Number.parseFloat(req.params.id));
    if(indiceProduto > -1){
